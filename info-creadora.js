...
correo = official[0][0] == String(contact[0]) ? '@gamil.com' : official[1][0] == String(contact[0]) ? '@gmail.com' : official[2][0] == String(contact[0]) ? '@gmail.com' : mail === '' ? lenguajeGB.smsContacto6() : mail
...
enlace = official[0][0] == String(contact[0]) ? 'https://' : official[1][0] == String(contact[0]) ? 'https://' : official[2][0] == String(contact[0]) ? 'https://' : official[3][0] == String(contact[0]) ? 'https://' : md 

lista.push([number, ofc, nombre, description, official[3][0] == String(contact[0]) ? null : correo, lugar, enlace, bio, official[1][0] == String(contact[0]) ? 'https://' : null]) }  
